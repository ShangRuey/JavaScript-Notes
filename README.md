...
## 5/11
1. [3110. Score of a String] [參考資料-charCodeAt()](https://blog.csdn.net/xiaobing_hope/article/details/78645273) [參考資料-Math.abs()](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Math/abs)
***
## 待完成筆記&每日閱讀筆記
